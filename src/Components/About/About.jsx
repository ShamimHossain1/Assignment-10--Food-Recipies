    ...
    return (
        <div className='lg:px-72'>
            ...
            <h2 className='text-lg font-semibold text-gray-600'>
                ...
                In addition to recipes, we also offer articles and resources on Chinese ingredients, cooking techniques, and cultural traditions. We believe that understanding the history and context of Chinese food is essential to truly appreciating its flavors and complexity. <br />

                Whether you're looking to learn a new recipe, explore a different type of Chinese cuisine, or simply satisfy your cravings for delicious food, our website has something for you. So come along on this culinary journey with us, and discover the wonders of Chinese food and culture!
            </h2>
        </div>
    );
};

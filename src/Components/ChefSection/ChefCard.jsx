...
const ChefCard = ({ chef }) => {
    ...
    const {name, picture, years_experience, num_recipes, likes  }=chef
    return (
        <div>
            <div className="max-w-sm">
                ...
                >
                    ...
                    <p className="font-semibold flex items-center justify-between text-xl text-gray-700 dark:text-gray-400">
                       Total {num_recipes} recipes <span><Link state={{state:chef}} to='/ChefDetails'><Button>View Recipes</Button></Link></span>
                    </p>
                </Card>
            </div>
        </div>
